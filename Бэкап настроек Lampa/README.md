...
* **Настройки по умолчанию**: Если бэкап для текущего устройства не найден, плагин предложит создать его или загрузить базовый файл по умолчанию (`default_settings.txt`).
...
После установки плагина в боковом меню Lampa появится новый пункт **«Резервное копирование»**. При нажатии на него откроется меню с тремя опциями:
...
* **Опционально** — можно создать саоего рода "шаблон настроек", если предварительно настроить одно устройство так, как вам надо, потом сохранить настройки и переименовать файл в `default_settings.txt`. Тогда на новом устройстве при вервом вызове восстановления настроек можно будет восстановить этот шаблон.
